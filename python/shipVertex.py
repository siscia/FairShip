...
# now go for the last step and vertex error
     scalFac[t1] = old_div((PosDirCharge[t1]['position'][2]-newPos[2]),PosDirCharge[t1]['direction'][2]/PosDirCharge[t1]['momentum'].Mag())
     scalFac[t2] = old_div((PosDirCharge[t2]['position'][2]-newPos[2]),PosDirCharge[t2]['direction'][2]/PosDirCharge[t2]['momentum'].Mag())
...
#   HNL true
     ...
     def getP(fitValues,cov,m1,m2):
       ...
       M_AtoP[0][0] = old_div((1.-old_div(a3*a3,A5)),(a5*ROOT.TMath.Sqrt(A5)))
       M_AtoP[0][1] = old_div((old_div(-a3*a4,A5)),(a5*ROOT.TMath.Sqrt(A5)))
       M_AtoP[0][2] = old_div((-a3),(a5*a5*ROOT.TMath.Sqrt(A5)))
       M_AtoP[0][3] = old_div((1.-old_div(a6*a6,A8)),(a8*ROOT.TMath.Sqrt(A8)))
       M_AtoP[0][4] = old_div((old_div(-a6*a7,A8)),(a8*ROOT.TMath.Sqrt(A8)))
       M_AtoP[0][5] = old_div((-a6),(a8*a8*ROOT.TMath.Sqrt(A8)))
       
       M_AtoP[1][0] = old_div((old_div(-a3*a4,A5)),(a5*ROOT.TMath.Sqrt(A5)))
       M_AtoP[1][1] = old_div((1.-old_div(a4*a4,A5)),(a5*ROOT.TMath.Sqrt(A5)))
       M_AtoP[1][2] = old_div((-a4),(a5*a5*ROOT.TMath.Sqrt(A5)))
       M_AtoP[1][3] = old_div((old_div(-a6*a7,A8)),(a8*ROOT.TMath.Sqrt(A8)))
       M_AtoP[1][4] = old_div((1.-old_div(a7*a7,A8)),(a8*ROOT.TMath.Sqrt(A8)))
       ...
       M_AtoP[3][0] = old_div((old_div(-2*a6,a5a8) + old_div(2*a3*E2,(a5*a5*A5*E1))),MM)
       M_AtoP[3][1] = old_div((old_div(-2*a7,a5a8) + old_div(2*a4*E2,(a5*a5*A5*E1))),MM)
       M_AtoP[3][2] = old_div((old_div(2*(1+a3*a6+a4*a7),(a5*a5a8)) - old_div(2*(1.+a3*a3+a4*a4)*E2,(a5*a5*a5*A5*E1))),MM)
       M_AtoP[3][3] = old_div((old_div(-2*a3,a5a8) + old_div(2*a6*E1,(a8*a8*A8*E2))),MM)
       M_AtoP[3][4] = old_div((old_div(-2*a4,a5a8) + old_div(2*a7*E1,(a8*a8*A8*E2))),MM)
       M_AtoP[3][5] = old_div((old_div(2*(1+a3*a6+a4*a7),(a8*a5a8)) - old_div(2*(1.+a6*a6+a7*a7)*E1,(a8*a8*a8*A8*E2))),MM)
