...
# Mass [E][T^2][L^-2]
#
kilogram = old_div(joule*second*second,(meter*meter))
gram = 1.e-3*kilogram
...
#
tesla     = old_div(volt*second,meter2)	# tesla =0.001*megavolt*ns/mm2
...
c_light   = old_div(2.99792458e+8 * m,s)
...
mu0      = old_div(4*pi*1.e-7 * henry,m)
...
#
k_Boltzmann = old_div(8.617385e-11 * MeV,kelvin)
...
#
universe_mean_density = old_div(1.e-25*g,cm3)
